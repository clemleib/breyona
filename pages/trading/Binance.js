          ...
          <div className="row text-left">
            <div className="col-md-8">
              <div>
                ...
                >
                  <li>
                    <b>√</b>&nbsp;&nbsp;17.5% return on all trading fees
                    (Exclusive)
                  </li>
                  <li>
                    <b>√</b>&nbsp;&nbsp;50% fee discount**
                  ...
                  <li>
                    <b>√</b>&nbsp;&nbsp;Trade over 100 cryptocurrencies
                  </li>
                  <li>
                    <b>√</b>&nbsp;&nbsp;High Liquidity
                  </li>
            ...
            <div className="col-md-4">
              ...
              <div>
                <a
                  target="_blank"
                  href="https://coinrewards.org/?ref=binaa"
            ...
            <div className="col-md-4">
              ...
              >
                <span>
                  Enter <b>25770202</b> as the referral ID:
                </span>
              </p>
              <a
                target="_blank"
                href="https://www.binance.com/register.html?ref=25770202"
              >
                <img
                  src="https://res.cloudinary.com/btcgrinders/image/upload/v1549890464/images/btcgrinders.com-binance-exchange-exclusive-discount-step2-formx.png"
                  height="auto"
                  width="320px"
                />
              </a>
            ...
            <Join>
              Enter your Binance Login Email
            </Join>
            <div className="container">
              <div className="row">
